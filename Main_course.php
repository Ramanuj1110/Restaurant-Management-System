...
<section class="showcase-area" id="showcase">
    <div class="showcase-container">
        <h1 class="main-title" id="home">Main Course</h1>
    </div>
</section>
   <div class="container">
    <div class="menu">
      ...
      <?php
        $query = "SELECT * FROM `food_detail` WHERE CATEGORY = 'Vegitable Dishes'";
      ...
      <div class="menu-group">
      <?php
        $query = "SELECT * FROM `food_detail` WHERE CATEGORY = 'Rice'";
        $data = mysqli_query($con, $query);
      ...
      <div class="menu-group">
      <?php
       $query = "SELECT * FROM `food_detail` WHERE CATEGORY = 'Dal'";
        $data = mysqli_query($con, $query);
      ...
      <div class="menu-group">
      <?php
        $query = "SELECT * FROM `food_detail` WHERE CATEGORY = 'Breads'";
        $data = mysqli_query($con, $query);
      ...
      <div class="menu-group">
      <?php
        $query = "SELECT * FROM `food_detail` WHERE CATEGORY = 'Dessert'";
        $data = mysqli_query($con, $query);
      ...
      <div class="menu-group">
      <?php
        $query = "SELECT * FROM `food_detail` WHERE CATEGORY = 'Our Speciality'";
        $data = mysqli_query($con, $query);
