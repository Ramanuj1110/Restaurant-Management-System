...
<body>
  ...
  <section class="showcase-area" id="showcase">
    <div class="showcase-container">
      <h1 class="main-title" id="home">DRINKS</h1>
    </div>
  </section>
  <div class="container">
    <div class="menu">
      ...
      <?php
        $query = "SELECT * FROM `food_detail` WHERE CATEGORY = 'Coffee & Tea'";
      ...
      <div class="menu-group">
      <?php
        $query = "SELECT * FROM `food_detail` WHERE CATEGORY = 'Juice'";
        $data = mysqli_query($con, $query);
      ...
      <div class="menu-group">
      <?php
        $query = "SELECT * FROM `food_detail` WHERE CATEGORY = 'Shakes'";
        $data = mysqli_query($con, $query);
      ...
      <div class="menu-group">
      <?php
        $query = "SELECT * FROM `food_detail` WHERE CATEGORY = 'Mocktail'";
        $data = mysqli_query($con, $query);
